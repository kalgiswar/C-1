...
def onsubmit():
    ...
    try:
        ...
        if sx < 0 or sx >= cols or sy < 0 or sy >= row or ex < 0 or ex >= cols or ey < 0 or ey >= row:
            messagebox.showerror("Error", "Coordinates out of range. Please enter values between 0 and " + str(cols-1))
            return
        ...
        messagebox.showerror("Error", "Invalid Input. Please enter x,y format.")
